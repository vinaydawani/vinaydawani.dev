  ...
  <div class="grid grid-cols-5 grid-flow-row w-full h-full">
    <div class="col-span-2">
      <ul class="px-28 space-y-4 mt-8">
        <li class="group portfolio-item portfolio-item-animation">
          <a href="https://chainsevm.netlify.app/" target="_blank">
            <div class="relative">
              <span class="portfolio-num">01</span>
        ...
        <li class="group portfolio-item portfolio-item-animation">
          <a href="https://spotiviz.vinaydawani.dev/" target="_blank">
            <div class="relative">
              <span class="portfolio-num">02</span>
        ...
        <li class="group portfolio-item portfolio-item-animation">
          <a href="https://github.com/vinaydawani/EZTracker" target="_blank">
            <div class="relative">
              <span class="portfolio-num">03</span>
        ...
        <li class="group portfolio-item portfolio-item-animation">
          <a href="https://github.com/vinaydawani/ISA-bot" target="_blank">
            <div class="relative">
              <span class="portfolio-num">04</span>
        ...
        <li
          class="group portfolio-item portfolio-item-animation cursor-pointer"
        >
          <div class="relative">
            <span class="portfolio-num">05</span>
        ...
        <li class="group portfolio-item portfolio-item-animation">
          ...
          >
            <div class="relative">
              <span class="portfolio-num">06</span>
        ...
        <li class="group portfolio-item portfolio-item-animation">
          ...
          >
            <div class="relative">
              <span class="portfolio-num">07</span>
        ...
        <li class="group portfolio-item portfolio-item-animation">
          <a href="https://trump.vinaydawani.dev/" target="_blank">
            <div class="relative">
              <span class="portfolio-num">08</span>
